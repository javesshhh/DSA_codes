...
private:
    int cap;
    int size;
    unordered_map<int, list<vector<int>>> mp; // key -> address of list of vector{key, value, freq}
...
public:
    ...
    void put(int key, int value)
    {
        ...
        { // Time to remove LFU or LRU if tie
            ...
            int key_delete = (kaun_sa_list.back())[0]; // ordered_map ensures that the begin() will be the least frequency
